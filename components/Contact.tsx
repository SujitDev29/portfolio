    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          data-reveal
          data-reveal-delay={getRevealDelay(0)}
        >
          {personalInfo.availableForHire && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-900/60 text-xs font-semibold uppercase tracking-wider font-display">
              <span aria-hidden="true" className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
              Available for hire
            </span>
          )}
          <p className="text-gray-600 dark:text-gray-400">
            The fastest way to reach me is email — typically same-day. LinkedIn
            and GitHub work too.
          </p>
        </div>
        ...
        <div className="mt-10 grid sm:grid-cols-3 gap-4">
          {contactItems.map((item, i) => (
            <a
              ...
              className="flex flex-col gap-3 p-5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:border-gray-300 dark:hover:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800/60 transition-[transform,border-color,background-color] duration-200 group hover:-translate-y-0.5"
            >
